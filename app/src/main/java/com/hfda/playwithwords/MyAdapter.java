...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder>
{
    ...
    private static final int TYPE_ITEM = 1;//Menu
    ...
    //infor Header
    private String mUserName;       //String Resource for header View UserName
    private int mProfile;        //int Resource for header view profile picture
    private String mPoint;       //String Resource for header view point
        ...
        public ViewHolder(View itemView,int ViewType, Context c)
        {
            ...
            if(ViewType == TYPE_ITEM)//Menu
            {
            ...
            else //Header
             {
                ...
                userName = (TextView) itemView.findViewById(R.id.headUserName);         // Creating Text View object from header.xml for name
                point = (TextView) itemView.findViewById(R.id.headPoint);       // Creating Text View object from header.xml for email
                rank=(TextView)itemView.findViewById(R.id.headRank);
    ...
    MyAdapter(String Titles[],int Icons[],String _userName,String _point,String _rank, int Profile,Context passedContext)
    { // MyAdapter Constructor with titles and icons parameter
        ...
        mPoint = _point;
        mProfile = Profile;
        mRank=_rank;//here we assign those passed values to the values we declared here
