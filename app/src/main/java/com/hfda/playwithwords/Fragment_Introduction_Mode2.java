...
public class Fragment_Introduction_Mode2 extends Fragment implements View.OnClickListener
{
    ImageButton backBtn;
    Button nextBtn;
    Introduction _container; //Activity bao hàm Fragment này

    public Fragment_Introduction_Mode2() {
                             ...
                             Bundle savedInstanceState)
    {
        ...
        RelativeLayout layout = (RelativeLayout)inflater.inflate(R.layout.fragment_introduction_mode2, container, false);
